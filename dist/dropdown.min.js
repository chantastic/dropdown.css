...
/***/ function(module, exports, __webpack_require__) {
	...
	var includes = __webpack_require__(1);
	...
	var contract = _require2.contract;
	var contractAll = _require2.contractAll;
	var focusDisclosureButton = _require2.focusDisclosureButton;
	var focusCloseLabel = _require2.focusCloseLabel;
	var toggle = _require2.toggle;


	function isNodeCloseButton(node) {
	  return node.getAttribute("aria-label") && node.getAttribute("aria-label") === "close";
	}

	function handleClickEvent(event) {
	  var target = event.target;

	  var popup = closest(target, "[aria-expanded]");

	  if (!popup && document.querySelector("[aria-expanded=true]")) {
	...
	function handleKeyupEvent(_ref) {
	...
	module.exports = { handlePopupEvent: handlePopupEvent };
...
/***/ function(module, exports, __webpack_require__) {
	...
	function contractAll() {
	  var popups = document.querySelectorAll("[aria-expanded]");

	  forEach(popups, function (p) {
	    return contract(p);
	  });
	}
	...
	function focusDisclosureButton(popup) {
	  var button = popup.querySelector("[aria-haspopup]");

	  if (button) popup.querySelector("[aria-haspopup]").focus();
	}

	function focusCloseLabel(popup) {
	  var closeLabel = popup.querySelector("[aria-label=close]");
	...
	module.exports = {
	  ...
	  expand: expand,
	  focusDisclosureButton: focusDisclosureButton,
	  focusCloseLabel: focusCloseLabel,
	  toggle: toggle
	};
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * Copyright Jeremy Ashkenas, DocumentCloud and Investigative Reporters & Editors
	 */
	var stringToPath = __webpack_require__(9);
